...
process ANNOTATE_INTERACTION_WITH_PEAKS {
  ...
  if (params.mode == 'basic')
    ...
    """
    interaction_annotation_multiple.py ${anchor_1_peak_collect} ${anchor_2_peak_collect} ${bed2D_index_anno} --prefix ${prefix} --sample ${sample} --network ${network} --complete ${complete} --upset_plot ${upset_plot} --circos_plot ${circos_plot}
