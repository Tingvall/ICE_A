...
if (params.mode == 'basic')
  ...
  """
  network_preprocessing_multiple.py ${interactions_annotated} ${interactions_annotated_not_aggregated} ${genes} --prefix ${prefix} --network_mode ${network_mode} --promoter_promoter ${promoter_promoter} --upset_plot ${upset_plot} --circos_plot ${circos_plot} --filter_genes ${filter_genes} --complete ${complete}
  """
