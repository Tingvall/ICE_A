...
# RUN FUNCTION
upset_plot(upset_promoter=args.UPSET_PROMOTER, upset_distal=args.UPSET_DISTAL, upset_promoter_g=args.UPSET_PROMOTER_G, upset_distal_g=args.UPSET_DISTAL_G, prefix=args.PREFIX, circos_plot=args.CIRCOS_PLOT, filter_genes=args.FILTER_GENES, complete=args.COMPLETE)
